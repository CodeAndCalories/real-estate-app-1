...
const INVESTOR_TYPES = [
  ...
  },
  {
    ...
    title: 'Wholesalers',
    description:
      'Surface distressed owners and expired listings across 8 markets in seconds. Export leads to CSV and push them directly into your dialer or CRM.',
    ...
    <section className={`py-20 px-6 ${isDark ? 'bg-gray-900' : 'bg-slate-50'}`}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className={`rounded-2xl border px-6 py-5 grid grid-cols-2 sm:grid-cols-4 gap-6 text-center ${
          ...
          {[
            { value: '900+', label: 'Signals analyzed', icon: '📊' },
            { value: '8',    label: 'Markets covered',  icon: '🏙️' },
