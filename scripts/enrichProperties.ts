...
const SAME_STATE_POOLS: Record<string, MailingTemplate[]> = {
  ...
  WA: [
    { street: 'Pike St',          city: 'Seattle',     state: 'WA', zip: '98101' },
    { street: 'Broadway Ave',     city: 'Seattle',     state: 'WA', zip: '98122' },
    { street: 'Aurora Ave N',     city: 'Seattle',     state: 'WA', zip: '98103' },
    { street: 'Rainier Ave S',    city: 'Seattle',     state: 'WA', zip: '98118' },
    { street: 'California Ave SW',city: 'Seattle',     state: 'WA', zip: '98116' },
  ],
  OR: [
    { street: 'Burnside St',      city: 'Portland',    state: 'OR', zip: '97209' },
    { street: 'Division St',      city: 'Portland',    state: 'OR', zip: '97202' },
    { street: 'Alberta St',       city: 'Portland',    state: 'OR', zip: '97211' },
    { street: 'Hawthorne Blvd',   city: 'Portland',    state: 'OR', zip: '97214' },
    { street: 'Mississippi Ave',  city: 'Portland',    state: 'OR', zip: '97217' },
  ],
  MN: [
    { street: 'Hennepin Ave',     city: 'Minneapolis', state: 'MN', zip: '55403' },
    { street: 'Nicollet Mall',    city: 'Minneapolis', state: 'MN', zip: '55402' },
    { street: 'Lake St',          city: 'Minneapolis', state: 'MN', zip: '55408' },
    { street: 'Central Ave NE',   city: 'Minneapolis', state: 'MN', zip: '55418' },
    { street: 'Grand Ave',        city: 'Saint Paul',  state: 'MN', zip: '55105' },
  ],
  MO: [
    { street: 'Broadway',         city: 'Kansas City', state: 'MO', zip: '64105' },
    { street: 'Main St',          city: 'Kansas City', state: 'MO', zip: '64108' },
    { street: 'Troost Ave',       city: 'Kansas City', state: 'MO', zip: '64110' },
    { street: 'Ward Pkwy',        city: 'Kansas City', state: 'MO', zip: '64112' },
    { street: 'Delmar Blvd',      city: 'St. Louis',   state: 'MO', zip: '63112' },
  ],
  MD: [
    { street: 'Charles St',       city: 'Baltimore',   state: 'MD', zip: '21201' },
    { street: 'North Ave',        city: 'Baltimore',   state: 'MD', zip: '21213' },
    { street: 'York Rd',          city: 'Baltimore',   state: 'MD', zip: '21212' },
    { street: 'Harford Rd',       city: 'Baltimore',   state: 'MD', zip: '21218' },
    { street: 'Belair Rd',        city: 'Baltimore',   state: 'MD', zip: '21214' },
  ],
  MI: [
    { street: 'Woodward Ave',     city: 'Detroit',     state: 'MI', zip: '48201' },
    { street: 'Michigan Ave',     city: 'Detroit',     state: 'MI', zip: '48216' },
    { street: 'Grand River Ave',  city: 'Detroit',     state: 'MI', zip: '48208' },
    { street: 'Jefferson Ave',    city: 'Detroit',     state: 'MI', zip: '48207' },
    { street: 'Eight Mile Rd',    city: 'Detroit',     state: 'MI', zip: '48234' },
  ],
  PA: [
    { street: 'Penn Ave',         city: 'Pittsburgh',  state: 'PA', zip: '15222' },
    { street: 'Liberty Ave',      city: 'Pittsburgh',  state: 'PA', zip: '15222' },
    { street: 'Forbes Ave',       city: 'Pittsburgh',  state: 'PA', zip: '15213' },
    { street: 'Butler St',        city: 'Pittsburgh',  state: 'PA', zip: '15201' },
    { street: 'Carson St',        city: 'Pittsburgh',  state: 'PA', zip: '15203' },
  ],
  UT: [
    { street: 'State St',         city: 'Salt Lake City', state: 'UT', zip: '84111' },
    { street: 'Main St',          city: 'Salt Lake City', state: 'UT', zip: '84101' },
    { street: '900 South St',     city: 'Salt Lake City', state: 'UT', zip: '84105' },
    { street: 'Foothill Dr',      city: 'Salt Lake City', state: 'UT', zip: '84108' },
    { street: 'Highland Dr',      city: 'Salt Lake City', state: 'UT', zip: '84106' },
  ],
  LA: [
    { street: 'Magazine St',      city: 'New Orleans', state: 'LA', zip: '70115' },
    { street: 'St Charles Ave',   city: 'New Orleans', state: 'LA', zip: '70130' },
    { street: 'Canal St',         city: 'New Orleans', state: 'LA', zip: '70112' },
    { street: 'Frenchmen St',     city: 'New Orleans', state: 'LA', zip: '70116' },
    { street: 'Esplanade Ave',    city: 'New Orleans', state: 'LA', zip: '70116' },
  ],
}
