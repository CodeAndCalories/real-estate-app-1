#!/usr/bin/env node
/**
 * scripts/addOhioMichigan.js
 *
 * Adds 500 records for each of 20 new Ohio + Michigan cities.
 * APPENDS to lib/data/generated-signals.json — does NOT overwrite.
 *
 * Total new records: 20 × 500 = 10,000
 * Expected total: 75,000 → 85,000
 *
 * Usage: node scripts/addOhioMichigan.js
 */
'use strict';
...
// ── 20 Ohio + Michigan cities ─────────────────────────────────────────────────
// avgPrice  = (minPrice + maxPrice) / 2
// priceRange = maxPrice - minPrice
// avgPriceSqft = rough market $/sqft
const NEW_CITIES = [
  // ── Ohio ──────────────────────────────────────────────────────────────────
  { name: 'Parma',           state: 'OH', abbr: 'prm',  zipStart: 44129, zipEnd: 44134, avgPrice: 230000, priceRange: 180000, avgPriceSqft: 133, areaCode: '216' },
  { name: 'Lakewood',        state: 'OH', abbr: 'lkw',  zipStart: 44107, zipEnd: 44112, avgPrice: 270000, priceRange: 220000, avgPriceSqft: 150, areaCode: '216' },
  { name: 'Euclid',          state: 'OH', abbr: 'euc',  zipStart: 44117, zipEnd: 44122, avgPrice: 170000, priceRange: 140000, avgPriceSqft: 117, areaCode: '216' },
  { name: 'Strongsville',    state: 'OH', abbr: 'str',  zipStart: 44136, zipEnd: 44141, avgPrice: 350000, priceRange: 260000, avgPriceSqft: 183, areaCode: '440' },
  { name: 'Canton',          state: 'OH', abbr: 'can',  zipStart: 44701, zipEnd: 44706, avgPrice: 180000, priceRange: 160000, avgPriceSqft: 120, areaCode: '330' },
  { name: 'Youngstown',      state: 'OH', abbr: 'yng',  zipStart: 44501, zipEnd: 44506, avgPrice: 120000, priceRange: 120000, avgPriceSqft:  83, areaCode: '330' },
  { name: 'Toledo',          state: 'OH', abbr: 'tol',  zipStart: 43601, zipEnd: 43606, avgPrice: 180000, priceRange: 160000, avgPriceSqft: 120, areaCode: '419' },
  { name: 'Lorain',          state: 'OH', abbr: 'lor',  zipStart: 44052, zipEnd: 44057, avgPrice: 140000, priceRange: 120000, avgPriceSqft: 100, areaCode: '440' },
  { name: 'Elyria',          state: 'OH', abbr: 'ely',  zipStart: 44035, zipEnd: 44040, avgPrice: 170000, priceRange: 140000, avgPriceSqft: 117, areaCode: '440' },
  { name: 'Mentor',          state: 'OH', abbr: 'mnt',  zipStart: 44060, zipEnd: 44065, avgPrice: 280000, priceRange: 200000, avgPriceSqft: 156, areaCode: '440' },
  // ── Michigan ──────────────────────────────────────────────────────────────
  { name: 'Warren',          state: 'MI', abbr: 'wrn',  zipStart: 48088, zipEnd: 48093, avgPrice: 250000, priceRange: 180000, avgPriceSqft: 139, areaCode: '586' },
  { name: 'Sterling Heights', state: 'MI', abbr: 'sth', zipStart: 48310, zipEnd: 48315, avgPrice: 310000, priceRange: 220000, avgPriceSqft: 172, areaCode: '586' },
  { name: 'Livonia',         state: 'MI', abbr: 'liv',  zipStart: 48150, zipEnd: 48155, avgPrice: 340000, priceRange: 240000, avgPriceSqft: 189, areaCode: '734' },
  { name: 'Dearborn',        state: 'MI', abbr: 'drb',  zipStart: 48120, zipEnd: 48125, avgPrice: 230000, priceRange: 180000, avgPriceSqft: 133, areaCode: '313' },
  { name: 'Ann Arbor',       state: 'MI', abbr: 'ann',  zipStart: 48103, zipEnd: 48108, avgPrice: 580000, priceRange: 400000, avgPriceSqft: 322, areaCode: '734' },
  { name: 'Lansing',         state: 'MI', abbr: 'lan',  zipStart: 48901, zipEnd: 48906, avgPrice: 200000, priceRange: 160000, avgPriceSqft: 125, areaCode: '517' },
  { name: 'Flint',           state: 'MI', abbr: 'flt',  zipStart: 48501, zipEnd: 48506, avgPrice:  90000, priceRange: 100000, avgPriceSqft:  67, areaCode: '810' },
  { name: 'Grand Rapids',    state: 'MI', abbr: 'grr',  zipStart: 49501, zipEnd: 49506, avgPrice: 340000, priceRange: 240000, avgPriceSqft: 189, areaCode: '616' },
  { name: 'Kalamazoo',       state: 'MI', abbr: 'kzoo', zipStart: 49001, zipEnd: 49006, avgPrice: 280000, priceRange: 200000, avgPriceSqft: 167, areaCode: '269' },
  { name: 'Dearborn Heights', state: 'MI', abbr: 'drh', zipStart: 48125, zipEnd: 48130, avgPrice: 220000, priceRange: 160000, avgPriceSqft: 128, areaCode: '313' },
];

// ── Signal engine (identical logic to addCitiesExpansion.js) ──────────────────
...
function generateProps(city, count) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const basePrice = Math.max(40000, rand(
...
console.log('\n── Generating 500 records per city ─────────────────────────────────');
for (const city of NEW_CITIES) {
  const batch = generateProps(city, 500);
  newSignals.push(...batch);
  console.log(`  ${city.name.padEnd(22)} ${city.state}  +${batch.length}`);
}
...
const byState = {};
for (const s of combined) byState[s.city] = s.city; // placeholder, use city map

console.log(`\nTotal unique cities: ${Object.keys(byCity).length}`);

console.log('\n── New Ohio cities ──────────────────────────────────────────────────');
const ohCities = NEW_CITIES.filter(c => c.state === 'OH');
for (const city of ohCities) {
  console.log(`  ${city.name.padEnd(22)} OH  ${(byCity[city.name] || 0).toLocaleString()} records`);
}

console.log('\n── New Michigan cities ──────────────────────────────────────────────');
const miCities = NEW_CITIES.filter(c => c.state === 'MI');
for (const city of miCities) {
  console.log(`  ${city.name.padEnd(22)} MI  ${(byCity[city.name] || 0).toLocaleString()} records`);
}

console.log('\n── Summary ──────────────────────────────────────────────────────────');
console.log(`  Ohio cities added:     ${ohCities.length}`);
console.log(`  Michigan cities added: ${miCities.length}`);
console.log(`  Total new records:     ${newSignals.length.toLocaleString()}`);
