        ...
        <div className="w-full max-w-md p-8 bg-white/[0.03] border border-white/10 backdrop-blur-xl rounded-2xl shadow-2xl">
          ...
          {forgotOpen ? (
            ...
            <>
              <button
                type="button"
                onClick={() => { setForgotOpen(false); setResetError(''); setResetSuccess(false); setResetEmail('') }}
                className="flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-300 transition-colors mb-6"
              >
                ← Back to login
              </button>

              {resetSuccess ? (
                <p className="text-sm text-green-400 text-center py-4">Check your email for a reset link</p>
              ) : (
                <>
                  {resetError && (
                  ...
                  <form onSubmit={handleResetPassword} noValidate className="space-y-5">
                    <div>
                      <label htmlFor="reset-email" className="block text-sm font-semibold text-gray-300 mb-1.5">
                        Email address
                      </label>
                      <input
                        id="reset-email"
                    ...
                    <button
                      ...
                      className="w-full bg-blue-600 hover:bg-blue-500 disabled:opacity-70 disabled:cursor-not-allowed text-white font-bold py-3 px-4 rounded-xl text-sm transition-all shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2"
                    >
                      {resetLoading ? (
                        <>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-5">
                ...
                <div className="flex justify-end -mt-2">
                  <button
                    type="button"
                    onClick={() => { setForgotOpen(true); setResetError(''); setResetSuccess(false) }}
